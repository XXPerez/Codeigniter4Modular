...
var modalLoading = {
    ...
    show: function () {
        console.log('openModalLoading show');
        var elem = document.getElementById("openModalLoading");
    ...
    hide: function () {
        var elem = document.getElementById("openModalLoading");
        console.log('openModalLoading hide');
        elem.style.display = "none";
    },
    construct: function () {
        var _this = this;
        var html = '<div id="openModalLoading" class="modalDialog" style="display:none;"><div>AAAAA<div class="loading-spinner"></div></div></div>';
